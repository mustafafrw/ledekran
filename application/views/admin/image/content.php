    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form data-url="<?php echo base_url("admin/urunler/refresh_image_list/$item->post_id"); ?>" action="<?php echo base_url("admin/urunler/product/image_upload/$item->post_id"); ?>" id="dropzone" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?php echo base_url("admin/urunler/image_upload/$item->post_id"); ?>'}">
