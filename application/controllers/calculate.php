...
class calculate extends CI_Controller {
  ...
  public function __construct() {
    ...
    public function calc(){
        ...
        $slcPanelHeight = str_replace(",",".",$this->input->post("h"));
        $slcPanelWidth =  str_replace(",",".",$this->input->post("w"));
        ...
        if ($pixelCalculate > 99000) {
                    ...
                    $this->cardAmount($slcPanelHeight, $slcPanelWidth, $inpPixels, $cardType, $usingPanelSize, $adaptorSize, $cardPrice, $kasaMetre, $rPanel, $pixelCalculate, $inpPanelHeight, $inpPanelWidth, $inpPanelMM, $cardId);
         }
         else {
            $kasaMetre = 0;
            $this->cardAmount($slcPanelHeight, $slcPanelWidth, $inpPixels, $cardType, $usingPanelSize, $adaptorSize, $cardPrice, $kasaMetre, $rPanel, $pixelCalculate, $inpPanelHeight, $inpPanelWidth, $inpPanelMM, $cardId);
    ...
    public function cardAmount($slcPanelHeight, $slcPanelWidth, $inpPixels, $cardType, $usingPanelSize, $adaptorSize, $cardPrice, $kasaMetre, $rPanel, $pixelCalculate, $inpPanelHeight, $inpPanelWidth, $inpPanelMM, $cardId) {
        ...
        $tvProductAmount = 0;
        $this->calculatePanel($slcPanelHeight, $slcPanelWidth, $inpPixels, $cardType, $usingPanelSize, $adaptorSize, $cardPrice, $kasaMetre, $rPanel, $tvProductAmount, $pixelCalculate, $inpPanelHeight, $inpPanelWidth, $inpPanelMM);
    ...
    public function calculatePanel($slcPanelHeight, $slcPanelWidth, $inpPixels, $cartType, $usingPanelSize, $adaptorSize, $cardPrice, $kasaMetre, $rPanel, $tvProductAmount, $pixelCalculate, $inpPanelHeight, $inpPanelWidth, $inpPanelMM) {
